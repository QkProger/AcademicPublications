                                    ...
                                    <tr class="filters">
                                        ...
                                        <td>
                                            <input v-model="filter.name" class="form-control"
                                                placeholder='Аты' @keyup.enter="search" />
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <input v-model="filter.surname" class="form-control"
                                                placeholder='Фамилия' @keyup.enter="search" />
                                        </td>
                                        <td></td>
                                        <td>
                                            <input v-model="filter.iin" class="form-control"
                                                placeholder='ИИН' @keyup.enter="search" />
                                        </td>
                                        <td></td>
                                        <!-- <td>
